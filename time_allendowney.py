...
class Time:
    ...
    def print_time(t):
        """ Print a string representation of the time
        t: Time object
        """
    ...
    def add_time(t1, t2):
      ...
      returns: Time
      """
      assert valid_time(t1) and valid_time(t2) # assert valid if it's True
      seconds = time_to_int(t1) + time_to_int(t2)
      return int_to_time(seconds)
    
    def valid_time(time):
      """ Checks wheter a Time object satisfies the invariants
      time: Time
      returns: boolean
      """
